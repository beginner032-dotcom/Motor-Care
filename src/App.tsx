...
import DokumenView from './components/views/DokumenView';
import KilometerView from './components/views/KilometerView';
import PengeluaranView from './components/views/PengeluaranView';
import PengingatView from './components/views/PengingatView';
...
export default function App() {
  ...
  const renderView = () => {
    switch (activeTab) {
      ...
      case 'dokumen': return <DokumenView onChangeTab={setActiveTab} />;
      case 'kilometer': return <KilometerView onChangeTab={setActiveTab} />;
      case 'pengeluaran': return <PengeluaranView onChangeTab={setActiveTab} />;
      case 'pengingat': return <PengingatView onChangeTab={setActiveTab} />;
      default: return <Dashboard onChangeTab={setActiveTab} />;
    }
  };

  return (
    <div className="min-h-screen bg-[#F0F2F5] dark:bg-black flex justify-center text-[#1F2937] dark:text-gray-100 transition-colors duration-300">
      {/* Mobile Simulator Container */}
      <div className="w-full max-w-md bg-[#F8FAFC] dark:bg-gray-900 h-screen relative overflow-hidden shadow-2xl flex flex-col font-sans transition-colors duration-300">
